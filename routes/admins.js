...
import { addAdmin, getAll, adminLogin, adminLogout, extend, getProfile, updateAdmin, deleteAdmin } from '../controllers/admins.js'
...
router.delete('/:id', auth.adminLogin, deleteAdmin)
